Sequence Diagram 1: Pokémon X attacks Pokémon Y, Pokémon Y does not defend itself.
```mermaid
---
title: CS6310 Group 6 Fall 2025 Attack Sequence Diagram
---
sequenceDiagram
	...
	activate randX
	randX -->> pokemonX: 0.123
	deactivate randX
	pokemonX ->> pokemonX: shouldAttack()
	pokemonX -->> pokemonX: true
	pokemonX ->> pokemonX: getOffensiveSkillList()
	pokemonX -->> pokemonX: [skill0, skill1]
	pokemonX ->> randX: nextInt(offensiveSkillList.size())
	activate randX
	randX -->> pokemonX: 0
	deactivate randX
	...
	pokemonY->>pokemonY: setCurrentHp(getCurrentHp()-skill0.getPower())
	deactivate pokemonY
	...
	pokemonX->>pokemonX: setCurrentHp(getCurrentHp()-skill3.getPower())
	deactivate pokemonX
