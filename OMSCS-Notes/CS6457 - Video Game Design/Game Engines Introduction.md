...
- A game engine is: 
	...
	- A sensory simulation meant to convince a game player that a virtual world exists and can be interacted with in real time
	- A simulation based on a rapid sequence of frames
